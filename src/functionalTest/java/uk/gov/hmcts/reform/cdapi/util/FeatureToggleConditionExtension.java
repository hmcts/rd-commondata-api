...
import uk.gov.hmcts.reform.cdapi.config.FeatureConditionEvaluation;
...
public class FeatureToggleConditionExtension implements ExecutionCondition {
    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
        ...
        return element.map(annotatedElement -> {
            ...
            return toggleEnable.map(toggle -> {
                ...
                final boolean isFlagEnabled = featureToggleService.isFlagEnabled("rd_commondata_api", flagName);
    ...
    public static String getToggledOffMessage() {
        return flagName.concat(" ").concat(FeatureConditionEvaluation.FORBIDDEN_EXCEPTION_LD);
    }
